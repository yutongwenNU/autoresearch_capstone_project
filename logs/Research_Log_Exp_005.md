...
### Configuration
* **Worker:** `model.py` — `HistGradientBoostingRegressor(learning_rate=0.05, max_iter=300, max_leaf_nodes=8, min_samples_leaf=5, l2_regularization=1.0, random_state=42)` inside a `Pipeline`
