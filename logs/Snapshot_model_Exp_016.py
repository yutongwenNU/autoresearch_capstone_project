...
# exp_016 — Sticky Vertical Moat: regulated-vertical signals indicating
# higher switching costs and stable revenue.
MOAT_KW = [
    "hipaa", "dental", "legal", "law firm", "manufacturing",
    "pci", "compliance", "regulated",
]
...
def main():
    ...
    print(f"has_moat tagged: {n_moat}/{len(df)} firms")
